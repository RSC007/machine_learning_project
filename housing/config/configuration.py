...
from housing.entity.config_entity import DataIngestionConfig, DataValidationConfig, TrainingPipelineConfig
...
class Configuration:
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        try:
            ...
            data_validation_config = self.config[DATA_VALIDATION_CONFIG_KEY]
